      ...
      <section className="w-full bg-base-100 py-20 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-1/2 space-y-6">
            ...
            <h2 className="text-2xl font-medium text-neutral-content">
      ...
      <section className="w-full bg-base-100 py-20 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-1/2 space-y-6">
            ...
            <div className="w-16 h-1 bg-primary"></div>
            <p className="text-base-content">
              At Dallas Glass and Auto, we are dedicated to delivering exceptional
              glass repair and replacement services at the most competitive
              prices. Our skilled technicians provide timely, professional
              service, offering customized solutions to meet both your auto and
              residential glass repair needs. Whether you're dealing with a
            ...
            <p className="text-xl font-semibold">
              Call Now! – <span className="text-primary"><Link href={'tel:+19729007194'}>(972) 900-7194</Link></span>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-base-100 py-20 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6 md:pr-10">
            ...
            <p className="text-base-content">
              When it comes to{" "}
              <strong>auto and residential glass repair</strong>, Dallas Glass and Auto
              is the trusted choice in{" "}
          ...
          <div className="space-y-6">
            ...
            <div className="text-base-content space-y-4">
              ...
              <p className="font-semibold">
                ...
                , trust <strong>Dallas Glass and Auto</strong> to get the job done
                right.{" "}
      ...
      <section className="w-full bg-base-100 py-20 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6 text-base-content">
            ...
            <p>
              At <strong>Dallas Glass and Auto</strong>, we specialize in more than
              just <strong>automotive glass repair and replacement</strong>—we
              also provide <strong>residential glass solutions</strong> to keep
