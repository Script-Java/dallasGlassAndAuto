...
export default async function handler(req, res) {
  ...
  try {
    const host = process.env.SMTP_HOST || "smtp.zoho.com"; // use smtp.zoho.eu/.in if your account is EU/IN
    ...
    const mailOptions = {
      // Zoho requires the "from" to be the authenticated mailbox or an approved alias on that mailbox
      from: `"Dallas Glass and Auto" <${process.env.SMTP_USER}>`,
...
<div style="font-family: Arial, sans-serif; padding: 20px; border: 4px solid #ccc; border-radius: 10px; line-height: 1.6; color: #000;">
  ...
  <strong style="font-size: 20px; color: #d62828; display: block; margin-bottom: 20px; margin-top: 0;">Dallas Glass and Auto</strong>
